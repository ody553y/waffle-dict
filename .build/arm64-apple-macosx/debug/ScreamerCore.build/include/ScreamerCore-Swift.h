...
#ifndef SCREAMERCORE_SWIFT_H
#define SCREAMERCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ScreamerCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12ScreamerCore19AudioCaptureService")
@interface AudioCaptureService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVAudioRecorder;
@interface AudioCaptureService (SWIFT_EXTENSION(ScreamerCore)) <AVAudioRecorderDelegate>
