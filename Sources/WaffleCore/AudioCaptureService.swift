...
public final class AudioCaptureService: NSObject, @unchecked Sendable {
    ...
    public init(
        ...
        let waffleDirectory = appSupport
            .appendingPathComponent("Waffle", isDirectory: true)
        self.scratchDirectory = waffleDirectory
            .appendingPathComponent("Scratch", isDirectory: true)
        self.audioFilesDirectory = waffleDirectory
