...
- A new small pasteboard/paste helper in `WaffleCore` owns clipboard writes and optional simulated `Cmd+V`
...
This should live in `WaffleCore` so it can be tested independently of SwiftUI.
